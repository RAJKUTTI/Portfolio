...
<h1 className={styles.title}>My Portfolio Highlights</h1>
    <div className={styles.container}>
      ...
      <div className={styles.card}>
        ...
        <h2>StayFinder | Discover Your Perfect Stay</h2>
        ...
        <p className={styles.tools}>Redux</p>
        <p className={styles.tools}>Tailwind CSS</p>
        <p className={styles.tools}>JWT Token</p>
        <p className={styles.tools}>Axios</p>
       </span>
       </div>

      <div className={styles.card}>
        <img src="/project-1.jpg" />
        <h2>NetflixGPT | AI Powered <br/>
            Movie Recommendations</h2>
        <div className={styles.arrowContainer}>
        <a href='https://flix-gpt-seven.vercel.app/'><button className={styles.arrowButton}>
            <ArrowOutwardIcon/>
        </button></a>
      </div>
        <span className={styles.toolscontainer}>
        ...
        <p className={styles.tools}>Redux</p>
        <p className={styles.tools}>Tailwind CSS</p>
        <p className={styles.tools}>Firebase</p>
        <p className={styles.tools}>GPT-3</p>
        </span>
      </div>

      <div className={styles.card}>
        <img src="/project-3.jpg"/>
        <h2>QKart | E-Commerce Platform</h2>
        <div className={styles.arrowContainer}>
